...
Download .zip-file of the repository and unzip it locally. In Fiji go to Plugins > Install PlugIn... and choose the Cluster_Analysis.jar file. After successful installation you should restart Fiji and find the plugin under Cluster Analysis
